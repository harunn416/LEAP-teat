    ...
    fetch(URL)
        ...
        .then(data => {
            ...
            for (let i = 0; i < 10; i++) {
                ...
                document.getElementsByClassName("question_text")[i].innerHTML = render_text[i][1];
                document.getElementById("tempWord").innerHTML = `${document.getElementById("tempWord").innerHTML + render_text[i][2]},`
            }
        })
        .catch(error => {
